...
p.addParamValue('initialMatrices',{}, @(x)(iscell(x)));
p.addParamValue('classwise',0, @(x)(~(x-floor(x))));
p.addParamValue('dim',size(trainSet,2), @(x)(sum(~(x-floor(x)))==length(x) || isvector(x)));
