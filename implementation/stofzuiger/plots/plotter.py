...
class KB_plotter:
    ...
    def show_plot(self):
        ...
        self.sub_plot(221, "MEP-aan",mdf[[self.xval,'mep_aan']],True,True,False,True)
        self.sub_plot(222, "MEP-uit", mdf[[self.xval,'mep_uit']],True,True,False,True)
        self.sub_plot(223, "Diff", mdf[[self.xval,'difference']],True,True,False,True)
